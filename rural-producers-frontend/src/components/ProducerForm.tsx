            ...
            z.object({
                ...
                plantedAreas: z
                    .array(
                        z
                            .number()
                            .min(0.01, "Área plantada deve ser maior que 0")
                    )
...
const ProducerForm: React.FC = () => {
    ...
    return (
        <div>
            ...
            >
                <Title level={2}>
                    {id ? "Editar Produtor" : "Novo Produtor"}
                </Title>
                <Button
            ...
            <Form layout="vertical" onFinish={handleSubmit(onSubmit)}>
                        ...
                        >
                            ...
                            >
                                ...
                                {!validateAreaSum(farmIndex) && (
                                    <Text type="danger">
                                        A soma das áreas agricultável e
                                        vegetação não pode ultrapassar a área
                                        total da fazenda.
                                    </Text>
                                )}
                                                            ...
                                                            >
                                                                <Select
                                                                    ...
                                                                    onChange={(
                                                                        ...
                                                                        setValue(
                                                                            `farms.${farmIndex}.plantedCrops.${cropIndex}.plantedAreas`,
                                                                            newAreas
                                                                        );
                                                                    }}
                                                                >
                ...
                <div style={{ textAlign: "center" }}>
                    <Space>
                        <Button onClick={() => navigate("/produtores")}>
                            Cancelar
                        </Button>
                        <Button
                            type="primary"
