...
export class ProducersController {
  ...
  @ApiResponse({ status: 409, description: 'Documento já existe no sistema' })
  ...
  @ApiQuery({ name: 'limit', required: false, description: 'Quantidade de itens por página', example: 10 })
  @ApiQuery({
    name: 'producerName',
    required: false,
